...
const projectsData = [
  ...
  },
  {
    id: 10,
    title: "FlyTheDragon",
    description: "Control your dragon in Augmented Reality.",
...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects">
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-2 py-6 text-white lg:flex-row md:flex-col">
        <ProjectTag
